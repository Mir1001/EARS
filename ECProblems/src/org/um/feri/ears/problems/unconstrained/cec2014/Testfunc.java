...
public class Testfunc {
	...
	/**
	 * Hack map that finds correct relative map
	 * @return
	 */
  public static String map() {
    return Testfunc.class.getProtectionDomain().getCodeSource().getLocation().getPath().replace("/bin/", "/data/cec2014/");
  }
	//public static  String map="//Users//minime//Documents//workspaceer2014//CEC2014//src//";
	...
	void test_func(double[] x, double[] f, int nx, int mx,int func_num)throws Exception{
		...
		if (ini_flag==0) /* initiailization*/
		{
			...
			/*Load Matrix M*****************************************************/
			File fpt = new File(map()+"input_data/M_"+func_num+"_D"+nx+".txt");//* Load M data *
			...
			if (func_num<23)
			{
				fpt=new File(map()+"input_data/shift_data_"+func_num+".txt");
			...
			{
				fpt = new File(map()+"input_data/shuffle_data_"+func_num+"_D"+nx+".txt");
