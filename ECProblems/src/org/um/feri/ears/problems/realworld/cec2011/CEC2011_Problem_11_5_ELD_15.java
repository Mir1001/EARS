...
public class CEC2011_Problem_11_5_ELD_15 extends Problem {
	...
	private static double[][] Data1={{ 150,  455,  0.000299,10.1,  671},
	...
	private static double[][] Data2={{400,  80,120,  150,150, 150,150,150,150},
	...
	private static double[][] B1={
		{1.4E-5, 1.2E-5, 0.7E-5, -0.1E-5, -0.3E-5, -0.1E-5, -0.1E-5, -0.1E-5, -0.3E-5, -0.5E-5, -0.3E-5, -0.2E-5, 0.4E-5, 0.3E-5, -0.1E-5}, 
		...
		{-0.1E-5, 0.1E-5, 0.0, 5.0E-5, -1.2E-5, -0.6E-5, 1.7E-5, 16.8E-5, 8.2E-5, 7.9E-5, -2.3E-5, -3.6E-5, 0.1E-5, 0.5E-5, -7.8E-5}, 
		...
		{-0.2E-5, 0.0E-5, 0.0, 0.0E-5, -0.2E-5, -0.1E-5, 0.7E-5, -3.6E-5, -2.5E-5, -3.4E-5, 0.1E-5, 5.4E-5, -0.1E-5, -0.4E-5, 2.8E-5}, 
	...
	public CEC2011_Problem_11_5_ELD_15() {
		...
		int z=0;
		intervalL[z] = 150;
		interval[z] = 455 - intervalL[z];
		z++;intervalL[z] = 150;
		interval[z] = 455 - intervalL[z];
		z++;intervalL[z] = 20;
		interval[z] = 130 - intervalL[z];
		z++;intervalL[z] = 20;
		interval[z] = 130 - intervalL[z];
		z++;intervalL[z] = 150;
		interval[z] = 470 - intervalL[z];
		z++;intervalL[z] = 135;
		interval[z] = 460 - intervalL[z];
		z++;intervalL[z] = 135;
		interval[z] = 465 - intervalL[z];
		z++;intervalL[z] = 60;
		interval[z] = 300 - intervalL[z];
		z++;intervalL[z] = 25;
		interval[z] = 162 - intervalL[z];
		z++;intervalL[z] = 25;
		interval[z] = 160 - intervalL[z];
		z++;intervalL[z] = 20;
		interval[z] = 80 - intervalL[z];
		z++;intervalL[z] = 20;
		interval[z] = 80 - intervalL[z];
		z++;intervalL[z] = 25;
		interval[z] = 85 - intervalL[z];
		z++;intervalL[z] = 15;
		interval[z] = 55 - intervalL[z];
		z++;intervalL[z] = 15;
		interval[z] = 55 - intervalL[z];
		name = "RWP_11_5_ELD_15";
		desc = "RWP_11_5_ELD_15 Static Economic Load Dispatch (ELD) Problem ";
	}
