...
public class Spea2fitness {
	...
	private MOParetoIndividual solutionSet_ = null;
	...
	public Spea2fitness(MOParetoIndividual solutionSet) {
	 ...
	 */
	public MOParetoIndividual environmentalSelection(int size) {
		...
		MOParetoIndividual aux = new MOParetoIndividual(solutionSet_.size());
